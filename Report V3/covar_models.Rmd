...
*`r ifelse(length(tree1)>1,paste("Figure 4.4.",i,sep=""),paste(" "))`*
...
*`r ifelse(length(tree1)>1,paste("Figure 4.5.",i,sep=""),paste(" "))`*
...
endmessage<-""
if(length(tree1)==1){
  endmessage<-paste("Variable not found to be statistically signifcant at 5% level. p=",
