...
```{r fetchdata, message = FALSE, eval=LOCAL}
...
```{r temperature, message=FALSE, eval=LOCAL}
...
```{r degreedays, message=FALSE, eval=LOCAL}
...
```{r temp_gdd, message=FALSE, eval=LOCAL}
temp <- temperature(data[c("lon","lat")], 
                    day.one = data["plantingdate"], 
                    span = gdd)
...
```{r rain, message=FALSE, eval=LOCAL}
...
```{r rain2, eval=FALSE, message=FALSE, eval=LOCAL}
rain <- rainfall(data[c("lon","lat")], 
                 day.one = data["plantingdate"], 
                 span = gdd,
                 days.before = 15)
...
```{r eto, message=FALSE, eval=LOCAL}
