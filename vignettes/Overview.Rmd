...
```{r fetch, message = FALSE, eval=LOCAL}
...
```{r plrankings, message = FALSE, eval=LOCAL}
...
```{r plmodel, message=FALSE, eval=LOCAL}
...
```{r pltree, echo=FALSE, fig.height=4, fig.width=8, message=FALSE, eval=LOCAL}
plot(tree)
```
