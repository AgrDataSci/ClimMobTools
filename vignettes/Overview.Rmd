...
```{r fetch, message=FALSE, eval=TRAVIS}
...
```{r plrankings, message = FALSE, eval=TRAVIS}
...
```{r plmodel, message=FALSE, eval=TRAVIS}
...
```{r pltree, echo=FALSE, fig.height=4, fig.width=8, message=FALSE, eval=TRAVIS}
plot(tree)
```
